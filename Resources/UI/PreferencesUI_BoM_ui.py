...
################################################################################
## Form generated from reading UI file 'PreferencesUI_BoMmxurQu.ui'
##
...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.SprHeaderForeGround_3.setProperty("prefEntry", QByteArray("SpreadSheetHeaderForeGround"))
        self.SprHeaderForeGround_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprHeaderBackGround_3.setProperty("prefEntry", QByteArray("SpreadSheetHeaderBackGround"))
        self.SprHeaderBackGround_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprHeaderFontStyle_Underline_3.setProperty("prefEntry", QByteArray("SpreadsheetHeaderFontStyle_Underline"))
        self.SprHeaderFontStyle_Underline_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprHeaderFontStyle_Bold_3.setProperty("prefEntry", QByteArray("SpreadsheetHeaderFontStyle_Bold"))
        self.SprHeaderFontStyle_Bold_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprHeaderFontStyle_Italic_3.setProperty("prefEntry", QByteArray("SpreadsheetHeaderFontStyle_Italic"))
        self.SprHeaderFontStyle_Italic_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableBackGround_5.setProperty("prefEntry", QByteArray("SpreadSheetTableBackGround_1"))
        self.SprTableBackGround_5.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableForeGround_3.setProperty("prefEntry", QByteArray("SpreadSheetTableForeGround"))
        self.SprTableForeGround_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableBackGround_6.setProperty("prefEntry", QByteArray("SpreadSheetTableBackGround_2"))
        self.SprTableBackGround_6.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableFontStyle_Bold_3.setProperty("prefEntry", QByteArray("SpreadsheetTableFontStyle_Bold"))
        self.SprTableFontStyle_Bold_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableFontStyle_Italic_3.setProperty("prefEntry", QByteArray("SpreadsheetTableFontStyle_Italic"))
        self.SprTableFontStyle_Italic_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprTableFontStyle_Underline_3.setProperty("prefEntry", QByteArray("SpreadsheetTableFontStyle_Underline"))
        self.SprTableFontStyle_Underline_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprColumnFontStyle_Bold_3.setProperty("prefEntry", QByteArray("SpreadsheetColumnFontStyle_Bold"))
        self.SprColumnFontStyle_Bold_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprColumnFontStyle_Underline_3.setProperty("prefEntry", QByteArray("SpreadsheetColumnFontStyle_Underline"))
        self.SprColumnFontStyle_Underline_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.SprColumnFontStyle_Italic_3.setProperty("prefEntry", QByteArray("SpreadsheetColumnFontStyle_Italic"))
        self.SprColumnFontStyle_Italic_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.AutoFitFactor_3.setProperty("prefEntry", QByteArray("AutoFitFactor"))
        self.AutoFitFactor_3.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.EnableDebugColumns.setProperty("prefEntry", QByteArray("EnableDebugColumns"))
        self.EnableDebugColumns.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
        ...
        self.EnableDebug_2.setProperty("prefEntry", QByteArray("EnableDebug"))
        self.EnableDebug_2.setProperty("prefPath", QByteArray("Mod/BoM Workbench"))
    ...
    def retranslateUi(self, Preferences):
        ...
        self.Spreadsheet_Layout_2.setTitle(QCoreApplication.translate("Preferences", "Table format", None))
        self.label_45.setText(QCoreApplication.translate("Preferences", "Header background       ", None))
        self.label_46.setText(QCoreApplication.translate("Preferences", "Header foreground", None))
        self.SprHeaderFontStyle_Underline_3.setText(QCoreApplication.translate("Preferences", "Underline", None))
        self.SprHeaderFontStyle_Bold_3.setText(QCoreApplication.translate("Preferences", "Bold", None))
        self.label_47.setText(QCoreApplication.translate("Preferences", "Header font style", None))
        self.SprHeaderFontStyle_Italic_3.setText(QCoreApplication.translate("Preferences", "Italic", None))
        self.label_48.setText(QCoreApplication.translate("Preferences", "Table foreground", None))
        self.label_50.setText(QCoreApplication.translate("Preferences", "Table background 2", None))
        self.label_49.setText(QCoreApplication.translate("Preferences", "Table background 1       ", None))
        self.SprTableFontStyle_Bold_3.setText(QCoreApplication.translate("Preferences", "Bold", None))
        self.label_51.setText(QCoreApplication.translate("Preferences", "Table font style", None))
        self.SprTableFontStyle_Italic_3.setText(QCoreApplication.translate("Preferences", "Italic", None))
        self.SprTableFontStyle_Underline_3.setText(QCoreApplication.translate("Preferences", "Underline", None))
        self.SprColumnFontStyle_Bold_3.setText(QCoreApplication.translate("Preferences", "Bold", None))
        self.label_52.setText(QCoreApplication.translate("Preferences", "1st column font style", None))
        self.SprColumnFontStyle_Underline_3.setText(QCoreApplication.translate("Preferences", "Underline", None))
        self.SprColumnFontStyle_Italic_3.setText(QCoreApplication.translate("Preferences", "Italic", None))
        self.label_53.setText(QCoreApplication.translate("Preferences", "Width factor for AutoFit", None))
        self.label.setText(
            QCoreApplication.translate(
                "Preferences", "FreeCAD needs to be restarted before changes become active.", None
            )
        )
        self.groupBox.setTitle(QCoreApplication.translate("Preferences", "Debug settings", None))
        self.EnableDebugColumns.setText(
            QCoreApplication.translate("Preferences", "Enable extra columns for debug", None)
        )
        ...
        self.EnableDebug_2.setText(QCoreApplication.translate("Preferences", "Debug mode", None))
