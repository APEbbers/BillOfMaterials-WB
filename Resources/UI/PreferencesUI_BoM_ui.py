...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy3.setHeightForWidth(self.SprHeaderForeGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.SprHeaderBackGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.SprTableBackGround_5.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.SprTableBackGround_6.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.SprTableForeGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.AutoFitFactor_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.EnableDebug_2.sizePolicy().hasHeightForWidth())
