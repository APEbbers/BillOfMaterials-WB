...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        sizePolicy1.setHeightForWidth(self.SprHeaderForeGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.SprHeaderBackGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.SprTableBackGround_5.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.SprTableForeGround_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.SprTableBackGround_6.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.AutoFitFactor_3.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.EnableDebug_2.sizePolicy().hasHeightForWidth())
