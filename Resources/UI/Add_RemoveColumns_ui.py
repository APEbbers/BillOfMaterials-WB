...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalSpacer_8 = QSpacerItem(5, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Minimum)
        ...
        self.horizontalSpacer_7 = QSpacerItem(5, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Minimum)
        ...
        self.horizontalSpacer_4 = QSpacerItem(5, 5, QSizePolicy.Policy.Fixed, QSizePolicy.Minimum)
        ...
        self.Columns_Present.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.verticalSpacer = QSpacerItem(10, 40, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        icon4 = QIcon()
        icon4.addFile(u"../../../../../Icons/General icons/Sort_AZ_Dark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Sort_AZ.setIcon(icon4)

        self.gridLayout_2.addWidget(self.Sort_AZ, 2, 12, 1, 2)

        self.horizontalSpacer_2 = QSpacerItem(5, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_2, 2, 7, 1, 1)

        self.horizontalSpacer_3 = QSpacerItem(5, 5, QSizePolicy.Policy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_3, 2, 2, 1, 2)

        self.horizontalSpacer_6 = QSpacerItem(5, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Minimum)
        ...
        self.Columns_To_Add.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
