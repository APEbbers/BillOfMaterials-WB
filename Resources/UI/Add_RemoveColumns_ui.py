...
from PySide.QtWidgets import (QAbstractButton, QAbstractItemView, QApplication, QDialog,
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon5 = QIcon()
        icon5.addFile(u"../Icons/Sort_ZA_Dark.png", QSize(), QIcon.Normal, QIcon.Off)
