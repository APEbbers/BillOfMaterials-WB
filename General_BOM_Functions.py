...
def createBoMSpreadsheet(
    ...
    Headers = Settings_BoM.ReturnHeaders(
        CustomHeaders=customHeaders, DebugHeaders=DEBUG_HEADERS
    )
    ...
    for i in range(len(CopyMainList)):
        ...
        for j in range(1, len(Headers) + 1):
            ...
            if Headers[Column + "1"] == "Number":
                ...
                sheet.set(Column + str(Row), "'" + ReturnDocProperty(rowList["DocumentObject"], "Parent"))
            elif Headers[Column + "1"] == "Type":
                sheet.set(Column + str(Row), "'" + rowList["Type"])
            elif Headers[Column + "1"].lower() == "label":
                sheet.set(
                    Column + str(Row),
                    ReturnDocProperty(rowList["DocumentObject"], "Label"),
                )
            elif Headers[Column + "1"].lower() == "name":
                sheet.set(
                    Column + str(Row),
                    ReturnDocProperty(rowList["DocumentObject"], "Name"),
                )
            elif Headers[Column + "1"].lower() == "fullname":
                sheet.set(
                    Column + str(Row),
                    ReturnDocProperty(rowList["DocumentObject"], "FullName"),
                )
            elif Headers[Column + "1"].lower() == "typeid":
                sheet.set(
                    Column + str(Row),
                    ReturnDocProperty(rowList["DocumentObject"], "TypeId"),
                )
                ...
                try:
                    if Headers[Column + "1"] == "FileName":
                        ...
                        value = ReturnViewProperty(rowList["DocumentObject"], Headers[Column + "1"])[0]
                        unit = ReturnViewProperty(rowList["DocumentObject"], Headers[Column + "1"])[1]
...
def ObjectCounter_ItemNumber(
    ...
    Item_Properties = ""
    try:
        Item_Properties = ReturnBodyProperties(ListItem["DocumentObject"])
    except Exception:
        pass
    ...
    for i in range(len(BomList)):
        ...
        try:
            BomListItem_Properties = ReturnBodyProperties(BomList[i]["DocumentObject"])
        except Exception:
            pass
...
def ObjectCounter(
    ...
    if ObjectBased is True:
        ...
        Item_Properties = ""
        try:
            Item_Properties = ReturnBodyProperties(DocObject["DocumentObject"])
        except Exception:
            pass
        ...
        for i in range(len(mainList)):
            BomListItem_Properties = ""
            try:
                BomListItem_Properties = ReturnBodyProperties(mainList[i]["DocumentObject"])
            except Exception:
                pass
    ...
    if ListRowBased is True:
        ...
        Item_Properties = ""
        try:
            Item_Properties = ReturnBodyProperties(RowItem["DocumentObject"])
        except Exception:
            pass
...
def CheckAssemblyType(DocObject):
    ...
    for RootObject in RootObjects:
        if RootObject.TypeId == "App::DocumentObjectGroup":
            RootObjects.extend(GetObjectsFromGroups(RootObject))
        ...
        if isShapeProperty is False:             
            try:
                ...
                if isinstance(resultValue, int):
                    ...
                    #     resultString = resultString + ObjectToString(item) + ", "
                    resultValue = str(resultValue)
...
def ReplacesAssembly(BoMList: list):
    ...
    for i in range(len(BoMList)):
        ...
        itemMaterial = ""
        try:
            itemMaterial = ReturnBodyProperties(BoMListItem["DocumentObject"])
        except Exception:
            pass
        ...
        for j in range(len(ReplaceList)):
            ...
            try:
                ReplacedItem_Properties = ReturnBodyProperties(ReplaceList[j]["DocumentObject"])
            except Exception:
                pass
