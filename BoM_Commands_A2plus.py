...
class CreatePartsOnlyBOM_A2plus_Class:
    def GetResources(self):
        return {
            "Pixmap": "A2plus-Parts.svg",  # the name of a svg file available in the resources
            "MenuText": "Create a parts only BoM",
            "ToolTip": "Create a parts only Bill of Materials in a spreadsheet",
        }

    def Activated(self):
        from GetBOM_A2plus import BomFunctions
...
class CreateSummarizedBOM_A2plus_Class:
    def GetResources(self):
        return {
            "Pixmap": "A2plus-Summary.svg",  # the name of a svg file available in the resources
...
class CreateTotalBOM_A2plus_Class:
    def GetResources(self):
        return {
            "Pixmap": "A2plus-Total.svg",  # the name of a svg file available in the resources
...
class CreateRawBOM_A2plus_Class:
    def GetResources(self):
        return {
            "Pixmap": "A2plus-Raw.svg",  # the name of a svg file available in the resources
...
Gui.addCommand("CreateBOM_PartsOnly_A2plus", CreatePartsOnlyBOM_A2plus_Class())
Gui.addCommand("CreateBOM_Summary_A2plus", CreateSummarizedBOM_A2plus_Class())
Gui.addCommand("CreateBOM_Total_A2plus", CreateTotalBOM_A2plus_Class())
Gui.addCommand("CreateBOM_Raw_A2plus", CreateRawBOM_A2plus_Class())
