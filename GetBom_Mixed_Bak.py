...
class BomFunctions:
    ...
    @classmethod
    def ReturnLinkedAssy_AppLink_Internal(self, docObject) -> App.DocumentObject:
        result = None
    ...
    @classmethod
    def ReturnEquealPart_AppLink_Internal(self, docObject, ObjectList: list):
    ...
    def GetTreeObjects(self) -> True:
                ...
                if RootObject.Name.startswith("Assembly") is False:
                    if (
                        self.AllowedObjectType(
                            objectID=RootObject.TypeId, AssemblyType=AssemblyType
                        )
                        is True
                    ):
                        docObjects.append(RootObject)
        ...
        if AssemblyType == "AppLink" or AssemblyType == "Internal":
            ...
            for docObject in docObjects:
                if (
                    self.AllowedObjectType(
                        objectID=docObject.TypeId, AssemblyType=AssemblyType
                    )
                    is True
                ):
                    docObjects = self.ReturnEquealPart_AppLink_Internal(
            ...
            for docObject in docObjects:
                ...
                object = self.ReturnLinkedAssy_AppLink_Internal(docObject=docObject)
    ...
    def GoThrough_Objects(
        ...
        for i in range(len(docObjects)):
            ...
            try:
                ...
                AssemblyType = self.CheckAssemblyType_Child(docObject)
                        ...
                        if AssemblyType == "A2plus":
                            ...
                            if docObject.subassemblyImport is True:
                                ...
                                if len(childObjects) > 0:
                                    self.mainList[len(self.mainList) - 1][
                                        "Type"
                                    ] = AssemblyType
                        ...
                        if AssemblyType == "Assembly3":
                            ...
                            for k in range(len(docObject.getSubObjects())):
                                if (
                                    ...
                                    childObjects.append(
                                        docObject.getSubObject(
                                            subname=docObject.getSubObjects()[k],
                                            retType=1,
                                        ),
                                    )
                            if len(childObjects) > 0:
                                ...
                                for j in range(len(docObject.getSubObjects())):
                                    if (
                                        ...
                                        for k in range(len(Parts)):
                                            ...
                                            if (
                                                self.FilterLinkedParts_A4(
                                                    ObjectDocument=docObject.getSubObject(
                                                        subname=docObject.getSubObjects()[
                                                            j
                                                        ],
                                                        retType=1,
                                                    ),
    ...
    def GoThrough_ChildObjects(
        ...
        for i in range(len(ChilddocObjects)):
            ...
            try:
                ...
                if (
                    self.AllowedObjectType(
                        objectID=childObject.TypeId, AssemblyType=AssemblyType
                    )
                    is True
                ):
    ...
    @classmethod
    def CorrectItemNumbers(self, BoMList: list) -> list:
        """_summary_
